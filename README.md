...
## ⭐ 주요 기능
* <b>로그인/회원가입</b>
스프링 시큐리티를 활용하여 로그인/회원가입기능을 구현하였습니다.
교육받을때는 단순히 세션이나 쿠기를 사용해서 공부를했었는데 보안에 신경쓰기위해 처음으로 공부해보고 적용해봤습니다
시큐리티는 버전이 바뀔때마다 depreceate 되는게 많아 관련 자료들을 찾는게 어려웠어요
나중에는 토큰 기반인증 jwt를 적용해볼꺼에요
아마 이번 프로젝트에서 제일 어려웟던 부분인거같다
* <b>상품 등록</b>
